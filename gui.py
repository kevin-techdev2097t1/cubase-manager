#!/usr/bin/env python3
"""cubase-manager GUI — visual updater for cubase."""
...
class GUI:
 def __init__(self):
 self.root = tk.Tk()
 self.root.title("cubase-manager")
 self.root.geometry("500x400")
 self.root.resizable(False, False)

 # Header
 ttk.Label(self.root, text="cubase-manager", font=("Arial", 16, "bold")).pack(pady=10)
 ttk.Label(self.root, text="Cubase Configuion Tool").pack()
